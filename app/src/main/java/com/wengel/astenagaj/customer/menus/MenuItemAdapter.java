...
public class MenuItemAdapter<MenuItem> extends ArrayAdapter<MenuItem> {


    public MenuItemAdapter(Context context, ArrayList<MenuItem> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        menuItemPrice.setText(String.valueOf(menuItem.getPrice()));
